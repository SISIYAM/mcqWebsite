                    ...
                    <div class="card-body">
                      ...
                      <div class="my-2">
                       ...
                       if(mysqli_num_rows($checkStudent) > 0){
                        ...
                        <a href="result.php?Exam-History=<?=$row['exam_id']?>"><button class="btn btn-danger mr-2">View
                            Result
                          </button></a>
                        <?php
                       }else{
                       ...
                       ?>
                        <a href="result.php?Leader-Board=<?=$row['exam_id']?>"><button class="btn btn-info my-2">Leader
                            Board</button></a>
                      </div>
                    </div>
                  </div>
