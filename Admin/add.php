                        ...
                        <div class="col-12">
                          ...
                          <div style="display:flex" class="my-1">
                            ...
                            <div class="form-group col-1 mx-1">
                              <select class="form-select form-select-sm" aria-label=".form-select-sm example"
                                name="exam_start_month" required>
                            ...
                            <div class="form-group col-1 mx-1">
                              <select class="form-select form-select-sm" aria-label=".form-select-sm example"
                                name="exam_start_hours" required>
                                <option value="">Hours</option>
                                <?php
                              for ($i=1; $i <= 23; $i++) { 
                                ?>
                            ...
                            <div class="form-group col-1">
                              <select class="form-select form-select-sm" aria-label=".form-select-sm example"
                                name="exam_start_minutes" required>
                                <option value="">Minutes</option>
                                <?php
                                for ($i=0; $i <= 9; $i++) { 
                                  ?>
                            ...
                            <div class="form-group col-1 mx-1">
                              <select class="form-select form-select-sm" aria-label=".form-select-sm example"
                                name="exam_start_am_pm" required>
                          ...
                          <div style="display:flex" class="my-1">
                            ...
                            <div class="form-group col-1">
                              <select class="form-select form-select-sm" aria-label=".form-select-sm example"
                                name="exam_end_minutes" required>
                                <option value="">Minutes</option>
                                <?php
                              for ($i=0; $i <= 9; $i++) { 
                                ?>
